...
public class Jamespop : MonoBehaviour, IPointerEnterHandler,  IPointerExitHandler //required for mouse over effects
{   
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        //double the size of this object that the script is attached to
        gameObject.transform.localScale = new Vector3(  sizeX * 1.08f, sizeY * 1.08f, sizeZ * 1.08f );
    }
